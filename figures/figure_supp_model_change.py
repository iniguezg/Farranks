...
### SCRIPT FOR PLOTTING SUPP FIGURE (MODEL RANK CHANGE) IN FARRANKS PROJECT ###
...
if __name__ == "__main__":
	...
	saveloc_model = root_loc+'nullModel/v4/files/model/change/' #location of output files
	...
	'dpi' : 300,
	'savename' : 'figure_supp_model_change' }
...
# A: ptau dependence of rank change vs. rank in sims/theo
	...
	plt.ylabel( r'$C_t$', size=plot_props['xylabel'], labelpad=2 )
	...
	for pos_ptau, ptau in enumerate( ptau_vals ): #loop through ptau values
		...
		rankprops_model, = model_misc.model_props( ['rank'], params, loadflag, saveloc_model, saveflag )['rank']
		yplot_model = rankprops_model.loc[ 'rankchange' ]

		yplot_theo = model_misc.change_theo( params )
...
# B: pnu dependence of rank change vs. rank in sims/theo
